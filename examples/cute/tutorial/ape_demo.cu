            ...
            Alpha alpha, Beta beta)
{
  ...
  Tensor aurora_tCsA = thr_mma.aurora_partition_A_v5(sA);
  Tensor aurora_tCsB = thr_mma.aurora_partition_B_v5(sB);
  Tensor aurora_tCgC = thr_mma.aurora_partition_C_v5(gC);
  ...
  Tensor aurora_tCrC = thr_mma.aurora_make_fragment_C_v5(aurora_tCgC);                         // (MMA,MMA_M,MMA_N)
  clear(aurora_tCrC);
  Tensor aurora_tCrA = thr_mma.aurora_make_fragment_A_v5(aurora_tCsA);                         // (MMA,MMA_M,MMA_K,PIPE)
  Tensor aurora_tCrB = thr_mma.aurora_make_fragment_B_v5(aurora_tCsB);
